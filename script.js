...
function startGame() {
  ...
  pointsElement.classList.remove('hide');
...
var questions = [
  {
    ...
    answers: [
      { text: 'The Two Mouth Woman', correct: false },
      { text: 'The Dish Mansion at Bancho', correct: true},
      { text: 'Shellfish Ogre', correct: false },
      { text: 'Abondoned Old Woman, Ubasute', correct: false },
    ]
  },
  {
  ...
  },
  {
    ...
    answers: [
      { text: 'Cecil Hotel', correct: true },
      { text: 'Hotel Aeris', correct: false },
      { text: 'Orient Hotel', correct: false },
      { text: 'Park Front Hotel', correct: false }
    ]
  },
  {
    ...
    answers: [
      { text: 'Atomic Bomb aftermath of 1945', correct: true },
      { text: 'Japan Open Borders 1954', correct: false },
      { text: 'Global Financial Crisis 1992', correct: false },
      { text: 'The Great Hanshin Earthquake 1995', correct: false },
    ]
  },
  {
    ...
    answers: [
      { text: "the director", correct: false },
      { text: "the director's wife", correct: false },
      { text: "the director's neighbour", correct: false },
      { text: "the director's son", correct: true },
    ]
  }
]
